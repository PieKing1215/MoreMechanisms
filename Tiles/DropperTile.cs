...
namespace MoreMechanisms.Tiles {
    ...
    public class TEDropper : ModTileEntity {
        ...
        public override bool ValidTile(int i, int j) {
            ...
            return tile.active() && tile.type == mod.TileType("DropperTile") && tile.frameX == 0 && tile.frameY == 0;
        }
    ...
    public class DropperTile : ModTile {
        public override void SetDefaults() {
            ...
            //drop = mod.ItemType("DropperItem");

            TileObjectData.newTile.CopyFrom(TileObjectData.Style2x2);
            //TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(GetInstance<TEDropper>().Hook_AfterPlacement, -1, 0, true);
            ...
            disableSmartCursor = true;
            chest = "Dropper";
            chestDrop = mod.ItemType("DropperItem");
        ...
        public override void MouseOver(int i, int j) {
            ...
            if (chest < 0) {
                ...
                player.showItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Dropper";
                if (player.showItemIconText == "Dropper") {
                    player.showItemIcon2 = mod.ItemType("DropperTile");
            ...
            if (chest >= 0) {
                ...
                for (int ii = 0; ii < ch.item.Length; ii++) {
                    ...
                    if (it.active && !it.IsAir) {
                        Item.NewItem(i * 16, j * 16, 32, 32, it.type, 1, false, it.prefix, false, false);
                        if(it.stack == 1) {
                            ch.item[ii] = new Item();
                        }else {
                            it.stack--;
